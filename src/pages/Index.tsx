...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Custom Luxury Furniture Cape Town | Bespoke Couches & Beds - Kayahaus</title>
        <meta
          name="description"
          content="Cape Town's premier custom furniture maker. Handcrafted luxury couches, beds, TV units & kitchen fittings. Made-to-order in South Africa with free consultation."
        />
        <meta
          name="keywords"
          content="custom couches Cape Town, luxury beds South Africa, bespoke TV units, kitchen fittings Cape Town, upholstery services, handmade furniture South Africa"
        />
        <link rel="canonical" href="https://kayahaus.co.za" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebSite",
            "name": "Kayahaus",
            "description": "Custom luxury furniture maker in Cape Town, South Africa",
            "url": "https://kayahaus.co.za",
            "potentialAction": {
              "@type": "SearchAction",
              "target": "https://kayahaus.co.za/products?search={search_term_string}",
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://facebook.com/kayahaus",
              "https://instagram.com/kayahaus",
              "https://pinterest.com/kayahaus"
            ]
          })}
        </script>
      </Helmet>
